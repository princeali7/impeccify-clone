...
const portfolioImages = [
  ...
  { src: '/portfolio/5.pngavif', alt: 'Project 5' },
  { src: '/portfolio/6.pngavif', alt: 'Project 6' },
  { src: '/portfolio/7.pngavif', alt: 'Project 7' },
  { src: '/portfolio/8.pngavif', alt: 'Project 8' },
  { src: '/portfolio/9.pngavif', alt: 'Project 9' },
  { src: '/portfolio/10.pngavif', alt: 'Project 10' },
  { src: '/portfolio/11.pngavif', alt: 'Project 11' },
  { src: '/portfolio/12.pngavif', alt: 'Project 12' },
];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-8">
          <span className="inline-flex items-center gap-2 bg-white/[0.06] border border-white/[0.08] rounded-full px-4 py-1.5 text-sm text-gray-300">
            <span className="w-2 h-2 bg-[#FFC500] rounded-full animate-pulse" />
            Projects Open for March
          </span>
        </div>

        {/* Headline */}
        <div className="text-center max-w-[970px] mx-auto">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.08] tracking-tight mb-6">
            Custom Website Development Services That Transform Traffic Into{' '} Paying Users
