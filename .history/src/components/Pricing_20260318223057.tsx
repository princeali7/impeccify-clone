    ...
    <section id="pricing" className="relative py-9 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-12">
          <span className="text-sm text-blue-400 font-medium tracking-wide uppercase">Our Pricings</span>
        ...
        <div className="flex items-center justify-center gap-4 mb-12">
          ...
          <button
            ...
            className={`relative w-14 h-7 rounded-full transition-colors ${fastDelivery ? 'bg-blue-500' : 'bg-white/20'}`}
          >
            <span className={`absolute top-0.5 w-6 h-6 bg-white rounded-full transition-transform ${fastDelivery ? 'translate-x-7.5' : 'translate-x-0.5'}`} />
          </button>
