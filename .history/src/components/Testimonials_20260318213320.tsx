...
export default function Testimonials() {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          {testimonials.map((t, idx) => (
            <div
              key={idx}
              className="bg-white/[0.03] border border-white/[0.06] rounded-2xl p-6 hover:border-white/[0.12] transition-all duration-200 group"
            >
              {/* Stars */}
  ...
  {
    text: 'Coming from Webflow templates, this custom design was a game-changer. They understood our brand identity perfectly and created something that stands out.',
    name: 'Kai Nakamura',
    role: 'Founder',
    location: 'Japan',
  },
  {
    text: 'They designed our entire dashboard from scratch and it\'s a masterpiece. Our users went from complaining about the old interface to actually enjoying using our platform.',
    name: 'Sofia Rodriguez',
    role: 'Product Manager',
    location: 'Spain',
  },
  {
    text: 'They designed our corporate website with such elegance and professionalism. The Arabic and English versions look flawless. Clients are impressed before we even meet.',
    name: 'Ahmed Hassan',
    role: 'Business Owner',
    location: 'UAE',
  },
  {
    text: 'The e-commerce design they created for us is pure art. Every product page, checkout flow, and user journey was crafted with such precision. Our conversion rate jumped significantly.',
    name: 'Emma Thompson',
    role: 'E-commerce Director',
    location: 'Australia',
  },
  {
    text: 'Working with this team was seamless. They took our rough ideas and turned them into a polished, professional website that perfectly captures our brand.',
    name: 'David Kim',
    role: 'Marketing Director',
    location: 'South Korea',
  },
  {
    text: 'They transformed our outdated agency website into something that actually wins us clients. The portfolio showcase and case study layouts are designed so well.',
    name: 'Lucas Silva',
    role: 'Agency Owner',
    location: 'Brazil',
  },
  {
    text: 'Their UI/UX expertise is world-class. They redesigned our entire platform and made it accessible, beautiful, and incredibly user-friendly. Our user retention improved by 45%.',
    name: 'Oliver Schmidt',
    role: 'VP Product',
    location: 'Germany',
  },
