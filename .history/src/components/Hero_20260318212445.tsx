  ...
  return (
    <section className="relative pt-28 pb-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        {/* Portfolio Grid - real project screenshots */}
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 max-w-5xl mx-auto">
          {portfolioImages.map((img, i) => (
            <div
              key={i}
              className="aspect-[4/3] rounded-xl overflow-hidden border border-white/[0.06] hover:border-white/20 transition-all duration-200 hover:scale-[1.02] group"
            >
              <Image
                src={img.src}
                alt={img.alt}
