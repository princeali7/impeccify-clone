    ...
    <section id="process" className="relative py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          <span className="px-6 py-2 bg-[#151515] mx-auto block max-w-[180px] rounded-full">Project Scope</span>
                      ...
                      <div className="bg-white/[0.03] border border-white/[0.07] rounded-2xl p-8 hover:border-white/[0.14] hover:bg-white/[0.05] transition-all duration-300">
                        <div className="flex items-center gap-4 mb-5">
                          <div className="w-14 h-14 rounded-2xl bg-white/[0.06] border border-white/[0.1] flex items-center justify-center shrink-0">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="171" height="171" viewBox="0 0 171 171" fill="none"><script xmlns="" id="eppiocemhmnlbhjplcgkofciiegomcon"/><script xmlns=""/><script xmlns=""/><script xmlns=""/>
<path d="M106.572 50.1385C106.572 50.1385 110.106 53.6727 113.64 60.7413C113.64 60.7413 124.867 43.0699 134.846 39.5356" stroke="white" stroke-width="10.6028" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M71.3305 14.8365C53.6699 14.0888 40.0258 16.1232 40.0258 16.1232C31.4103 16.7393 14.8995 21.5693 14.8997 49.7777C14.8998 77.7462 14.717 112.227 14.8997 125.972C14.8997 134.37 20.0994 153.959 38.0971 155.009C59.9731 156.286 99.3777 156.557 117.457 155.009C122.297 154.736 138.409 150.937 140.449 133.406C142.562 115.245 142.141 102.623 142.141 99.6191" stroke="white" stroke-width="10.6028" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M156.189 50.1376C156.189 69.6569 140.35 85.4806 120.812 85.4806C101.274 85.4806 85.4357 69.6569 85.4357 50.1376C85.4357 30.6184 101.274 14.7949 120.812 14.7949C140.35 14.7949 156.189 30.6184 156.189 50.1376Z" stroke="white" stroke-width="10.6028" stroke-linecap="round"/>
<path d="M50.0232 92.5483H78.2972" stroke="white" stroke-width="10.6028" stroke-linecap="round"/>
<path d="M50.0232 120.822H106.571" stroke="white" stroke-width="10.6028" stroke-linecap="round"/>
</svg>
                          </div>
