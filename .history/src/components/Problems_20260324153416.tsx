    ...
    <section className="relative py-9 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <span className="px-6 py-2 bg-[#151515] mx-auto block max-w-[160px] rounded-full">Problems</span>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          {/* React & Next.js - Good */}
          <div className="bg-[#e3eb01]  border border-green-500/10 rounded-2xl p-8 hover:border-green-500/20 transition-all">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-bold text-black">React and Next.js</h3>
            </div>
            <p className="text-black text-sm mb-6">React and Next.js are the best option with full control of the website and the best performance and speed.</p>
            <ul className="space-y-3">
              {[
