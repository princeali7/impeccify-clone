...
function CSSConverter({ slug, config }: { slug: string; config: CSSConverterConfig }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Output */}
      <div className="bg-white/[0.06] border border-white/15 rounded-xl p-6 flex items-center justify-between">
        <div>
...
function ColorConverter({ slug }: { slug: string }) {
      ...
      return (
        <div className="bg-white/[0.04] border border-white/10 rounded-xl p-4">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg border border-white/10 flex-shrink-0" style={{ backgroundColor: hex }} />
            <input
              type="text"
              value={hex}
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-white/[0.06] border border-white/15 rounded-xl p-6 flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-xl border border-white/10 flex-shrink-0" style={{ backgroundColor: previewColor }} />
          <div>
        ...
        <button
          ...
          className="text-xs text-gray-500 hover:text-white transition-colors bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg px-3 py-2 flex-shrink-0"
        >
          Copy
        </button>
      </div>
    ...
    <>
      ...
      <main className="min-h-screen bg-black pt-24 pb-20">
        ...
        <section className="max-w-4xl mx-auto px-6 lg:px-8 py-10">
          {isCSSConverter ? (
            <CSSConverter slug={slug} config={cssConfigs[slug]} />
          ) : isColorConverter ? (
