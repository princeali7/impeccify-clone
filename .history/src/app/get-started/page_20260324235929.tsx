    ...
    <>
      ...
      <main className="min-h-screen bg-black flex flex-col items-center justify-center pt-16 pb-20 px-6">
        ...
        <div className="pointer-events-none fixed inset-0 overflow-hidden">
          <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[700px] h-[500px] bg-white/[0.03] rounded-full blur-3xl" />
        </div>
          ...
          <div className="bg-white/[0.04] border border-white/10 rounded-2xl p-8 backdrop-blur-sm">
            ...
            {tab === 'signup' ? (
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <button
                  type="submit"
                  className="w-full bg-white text-black font-semibold py-3 rounded-xl text-sm hover:bg-gray-100 active:scale-[0.98] transition-all duration-200 mt-2"
                >
                  Create Account
                </button>
