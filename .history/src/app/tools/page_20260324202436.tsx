...
const BASE = 'https://impeccify.com';
      ...
      <main className="min-h-screen bg-black pt-24 pb-20">
        ...
        <section className="max-w-5xl mx-auto px-6 lg:px-8 pt-10 pb-8 text-center">
          <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-xs text-gray-400 tracking-wide uppercase font-medium">Free Tools</span>
          </div>
              ...
              >
                ...
                <span
                  className={`text-xs px-1.5 py-0.5 rounded-full ${
                    activeId === cat.id ? 'bg-black/10 text-black' : 'bg-white/10 text-gray-500'
                  }`}
                >
                  {cat.count}
                </span>
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-8 space-y-14">
          {displayed.map((cat) => (
            <section key={cat.id} id={cat.id}>
              {/* Section header */}
              <div className="mb-6">
                <h2 className="text-xl font-bold text-white mb-1">{cat.label}</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {cat.tools.map((tool) => (
                  <a
                    ...
                    className="group flex flex-col gap-1 bg-white/[0.03] hover:bg-white/[0.07] border border-white/[0.08] hover:border-white/20 rounded-xl px-4 py-4 transition-all duration-200"
                  >
                    <span className="text-sm font-semibold text-white group-hover:text-white leading-snug">
                      {tool.name}
                    </span>
        ...
        {/* Footer note */}
        <div className="max-w-5xl mx-auto px-6 lg:px-8 mt-16 text-center">
