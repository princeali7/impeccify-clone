              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5">
                {cat.tools.map((tool) => (
                  <Link
                    key={tool.href}
                    href={tool.href}
                    className="group relative flex items-start justify-between gap-3 bg-white/[0.025] hover:bg-white/[0.06] border border-white/[0.07] hover:border-white/20 rounded-xl px-4 py-4 transition-all duration-150 active:scale-[0.98]"
                  >
                    ...
                    {/* Arrow icon */}
                    <svg
                      className="w-3.5 h-3.5 text-gray-700 group-hover:text-gray-400 transition-colors mt-0.5 shrink-0 translate-x-0 group-hover:translate-x-0.5 transition-transform duration-150"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
